...
public class JavaFXMain extends Application {
	...
	private void adicionarComponentes(Parent root) {
		...
		btn02.setLayoutY(100); // nao vai funcionar por causa do StackPane. Slide 21
		btn02.setLayoutX(100);
		
		// adicionando o botão ao painel
		if(root instanceof Pane) {
			((Pane) root).getChildren().addAll(btn01,btn02);
		} else {
			((Group) root).getChildren().addAll(btn01,btn02);
		}
